...
miu = 61.4 #根据题目信息输入平均值
n = 13 #根据题目信息输入样本数
xbar = 62.12 #根据题目信息输入xbar
s = 0.65 #根据题目信息输入s
...
cat("#################################################problem6#################################################\n")
n = 25 #根据题目信息输入样本数n
xbar = 5.9 #根据题目信息输入xbar
s1 = 0.81 #根据题目信息输入s1
m = 29 #根据题目信息输入样本数m
ybar = 6.5 #根据题目信息输入ybar
s2 = 1.45 #根据题目信息输入s2
...
#################################################problem7#################################################
cat("#################################################problem7#################################################\n")
data1 = c(586,590,608,639,583,653,543,569) #根据题目信息输入data1
data2 = c(501,536,571,502,502,482,530,503,559,577) #根据题目信息输入data2
